    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    {
        if ($connection instanceof CouchbaseDB) {
            $this->db = $connection;
        } else {
            ...
            $this->db = new CouchbaseDB($connection['servers'], (!isset($connection['username'])) ? '' : $connection['username'], (!isset($connection['password'])) ? '' : $connection['password'], $connection['bucket'], false);
        }
